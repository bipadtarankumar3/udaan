...
@section('content')
<form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" id="postForm" x-data="wpPostEditor()">
    @csrf
    ...
    <div class="space-y-5">
        ...
        <div class="bg-white px-5 py-3.5 rounded-2xl border border-slate-200/80 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sticky top-0 z-30 backdrop-blur-md bg-white/95">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-bold text-slate-700 uppercase tracking-wider">New Post</span>
                        <span class="text-slate-300">|</span>
                        <span class="text-xs text-slate-500" x-text="status === 'published' ? 'Ready to Publish' : 'Draft'"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.posts.index') }}" class="px-3.5 py-1.5 rounded-xl text-xs font-semibold text-slate-600 hover:bg-slate-100 transition">
                    Cancel
                </a>
                <button 
                    type="submit" 
                ...
                >
                    <i class="fa-regular fa-file-lines mr-1 text-[11px]"></i> Save Draft
                </button>
                <button 
                    type="submit" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div class="lg:col-span-4 space-y-5">
                ...
                <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden" x-data="imageUploader()">
                    <div class="bg-slate-50/80 px-4 py-3 border-b border-slate-100 flex items-center justify-between">
                        <h3 class="text-xs font-bold uppercase tracking-wider text-slate-700 flex items-center gap-1.5">
                    ...
                    <div class="p-4 space-y-3">
                        <div 
                            ...
                            class="border-2 border-dashed border-slate-200 hover:border-red-400 rounded-xl p-4 text-center cursor-pointer transition bg-slate-50/50 hover:bg-red-50/20 group relative overflow-hidden"
                        >
