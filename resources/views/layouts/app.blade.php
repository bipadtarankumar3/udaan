            ...
            <div class="flex items-center gap-2.5 sm:gap-3">
                ...
                <div class="relative" x-data="{ profileMenuOpen: false }">
                    <button 
                        ...
                        class="flex items-center gap-2.5 pl-1.5 pr-2.5 py-1 sm:pl-2 sm:pr-3 sm:py-1.5 rounded-2xl bg-slate-50 hover:bg-slate-100 border border-slate-200/90 transition text-left cursor-pointer group"
                        :class="profileMenuOpen ? 'bg-slate-100 border-slate-300 ring-2 ring-orange-500/15' : ''"
                    >
                        <div class="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-tr from-red-600 via-orange-500 to-amber-500 text-white flex items-center justify-center font-bold text-xs uppercase shadow-sm shadow-orange-500/20 group-hover:scale-105 transition-transform shrink-0">
                            {{ substr(auth()->user()->name, 0, 2) }}
                        </div>
                        <div class="hidden sm:block overflow-hidden max-w-[130px]">
                            <p class="text-xs font-bold text-slate-900 truncate leading-tight">{{ auth()->user()->name }}</p>
                            <div class="flex items-center gap-1.5 mt-0.5">
                                <span class="inline-block w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                                <span class="text-[10px] font-bold text-orange-600 uppercase tracking-wide truncate">
                                    {{ auth()->user()->roles->pluck('name')->first() ?? 'Staff' }}
                                </span>
                            </div>
                        </div>
                        <i class="fa-solid fa-chevron-down text-[10px] text-slate-400 group-hover:text-slate-600 transition-transform duration-200 ml-0.5" :class="profileMenuOpen ? 'rotate-180' : ''"></i>
                    </button>
                    ...
                    >
                        ...
                        <div class="px-4 py-2.5">
                            ...
                            <div class="mt-2 flex items-center gap-1.5">
                                <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-orange-50 text-orange-700 border border-orange-200 uppercase">
                        ...
                        <div class="py-1">
                            ...
                            @else
                                ...
                                <a 
                                    ...
                                    class="flex items-center gap-2.5 px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-orange-600 transition"
                                >
                                    <i class="fa-solid fa-phone-volume w-4 text-center text-slate-400"></i>
                                    <span>My Calling List</span>
                                </a>
                            @endif
                            <a 
                        ...
                        <div class="pt-1">
                            <button 
                                type="button" 
                                @click="profileMenuOpen = false; logoutModalOpen = true"
